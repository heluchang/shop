...
class AuthController
{
    ...
    public function get_openid($code='', $spread_code = '', $spread_spid = '')
    {
        // return app('json')->fail('登录失败123');
        return app('json')->success($this->services->reopenid($code, $spread_code, $spread_spid));
    }
